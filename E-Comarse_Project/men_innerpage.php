...
$sql="SELECT * FROM sub_catagory WHERE catagory_id=1";
...
?>
         ...
         <div class="">
          <a href="men_innerpage.php">
    <div class="mt-0">
      <img src="assets/image//mencollection1.avif" class="d-block w-100" alt="...">
    </div></a>
</div>
...
<div class="main-floor mt-3 ">
        <div class="max-w-full">
          <div class="max-w-full row bg-light justify-content-around">
            ...
            { ?>
            <a href="t-shirt_innerpage.php?id=<?php echo $val['id']; ?>">
              <div>
          <div class="relative px-3">
          <picture class="pic-ar ">
            <img alt="Men" src="<?php echo 'admin/subcat_pic/'.$val['subcat_pic']; ?>" class="ph-1">
          </picture>
        </div>
        <div class="first-text">
          <span><?php echo $val['subcatagory_name']; ?></span>
        </div>
      </div>
    </a>
    <?php } ?>
  ...
  <div>
        <div class="container-fluid bg-light mt-5 mb-5">
          <p class="h4 text-left mt-2 font-weight-bold pl-2">Men's All Collection
