...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/main.css">
	<title>Cricket_bat_innerpage</title>
</head>
<body>
...
?>
    ...
    <!-- <div class="max-w-full bg-info"> -->
      <div class="flex-box">
        <div class="left">
          <div class="big-img">
            <img src="assets/image/cricket_bat1part1.avif">
          </div>
          <div class="image">
            <div class="small-img ">
              <img src="assets/image/cricket_bat1part2.avif" onclick="showImg(this.src)">
            </div>
            <div class="small-img ">
              <img src="assets/image/cricket_bat1part3.avif" onclick="showImg(this.src)">
            </div>
            <div class="small-img ">
              <img src="assets/image/cricket_bat1part4.avif" onclick="showImg(this.src)">
            </div>
            <div class="small-img">
              <img src="assets/image/cricket_bat1part1.avif" onclick="showImg(this.src)">
            </div>
          </div>
        </div>
      ...
      <div class="right">
        ...
        <div class="pl-4">Product code : ISRC2023</div>
          <div class="shoe-rating pl-4">
            ...
            <div class="price pl-4">₹499 ₹<strike>599</strike></div>
            <div class="size pl-4">
              <h5>Size :</h5>
