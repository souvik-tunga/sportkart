...
?>
    ...
    <!-- <shoe1_innerpage_start> -->
      ...
      <div class="flex-box">
        <div class="left">
          <div class="big-img">
            <img src="assets/image/shoe1part0.avif">
          </div>
          <div class="image">
            <div class="small-img ">
              <img src="assets/image/shoe1part1.avif" onclick="showImg(this.src)">
            </div>
            <div class="small-img ">
              <img src="assets/image/shoe1part2.avif" onclick="showImg(this.src)">
            </div>
            <div class="small-img ">
              <img src="assets/image/shoe1part3.avif" onclick="showImg(this.src)">
            </div>
            <div class="small-img">
              <img src="assets/image/shoe1part4.avif" onclick="showImg(this.src)">
            </div>
          </div>
        </div>
      
      <div class="right">
        <div class="url pl-4">Home > Men > Running Shoe</div>
        <div class="shoe_name font-weight-bold pl-4">Men's Running Shoe</div>
        <div class="pl-4">Product code : ISRC2023</div>
          <div class="shoe-rating pl-4">
            ...
            <div class="price pl-4">₹1,199 ₹<strike>1,500</strike></div>
            <div class="size pl-4">
              <h5>Size :</h5>
